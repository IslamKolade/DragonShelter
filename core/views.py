...
from .models import AnimalResident, DragonShelterProfile, BookAnEncounterRequest, DragonShelterEvent
import cloudinary
...
def book_an_encounter(request):
    ...
    if request.method == 'POST':
        ...
        if event_exists:
            ...
            email_subject = 'Dragon Shelter Encounter Request Received'
